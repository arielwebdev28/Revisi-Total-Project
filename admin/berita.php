...
<body class="starter-page-page">
    ...
    <main class="main">
        ...
        <section id="berita-section" class="starter-section section">
        <!-- Section Title -->
        <div class="container">
            <a href="tambah-berita.php" class="btn btn-primary mt-2 mb-3">
            TAMBAH BERITA
            </a>
        </div>
                ...
                <table class="table table-bordered table-striped table-responsive w-100">
                    ...
                    <tr>
                        ...
                        <td class="w-25 text-center">
                            <a href="edit-berita.php" class="btn btn-warning ms-3 me-3">Edit</a> |   <a href="hapus-berita.php" class="btn btn-danger ms-3 me-3">Hapus</a>
                        </td>
                    </tr>
                </table>
            </form>
