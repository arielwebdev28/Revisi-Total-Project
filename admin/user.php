...
<body class="starter-page-page">
  ...
  <main class="main">
    ...
    <section id="user-section" class="starter-section section">
      <!-- Section Title -->
      <div class="container">
        <a href="tambah-user.php" class="btn btn-primary mt-2 mb-3">
          TAMBAH USER
        </a>
      </div>
          ...
          <table class="table table-bordered table-striped table-responsive w-100">
            ...
            <tr>
                ...
                <td class="text-center">
                    <a href="edit-user.php" class="btn btn-warning">Edit</a><a href="hapus-user.php" class="btn btn-danger ms-3 me-3">Hapus</a>
                </td>
            </tr>
          </table>
        </form>
